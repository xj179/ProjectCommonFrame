...
import com.common.projectcommonframe.utils.NetWorkUtil;
...
public class BaseApi {
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtil.isNetConnected(MyApplication.getInstance())) {//断网时配置缓存策略
...
//                        .cacheControl(CacheControl.FORCE_CACHE)
            ...
            if (NetWorkUtil.isNetConnected(MyApplication.getInstance())) {//在线缓存
//                KLog.e("在线缓存2分钟");
