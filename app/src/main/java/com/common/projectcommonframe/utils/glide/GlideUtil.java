package com.common.projectcommonframe.utils.glide;
...
public class GlideUtil {
    ...
    public static final int placeholderSoWhite = android.R.color.white;
    public static final int errorSoWhite = android.R.color.white;
    ...
    public static void loadImage(Context context, String url, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                ...
                .error(android.R.color.white)       //错误图
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    KLog.d("logcat", "下载好的图片文件路径=" + imageFile.getPath());
